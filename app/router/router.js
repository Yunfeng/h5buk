...
export function createRouter () {
  return new Router({
    ...
    routes: [
      ...
      { path: '/about', component: () => System.import('../pages/About.vue')},
      { path: '/item/:id', component: () => System.import('../pages/Item.vue')},
      { path: '/login', component: () => System.import('../pages/Login.vue')},
      { path: '/airports', component: () => System.import('../pages/Airports.vue')},

      { path: '/orders', component: () => System.import('../pages/Orders.vue')},
