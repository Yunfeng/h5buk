    ...
    <template v-if="detail">
      <div class="card col-12">
        <table class="table table-sm">
          ...
          <tr class="backFlightInfo">
              <td class="text-right text-info">回程舱位</td>
              <td>{{detail.backSubclass}}</td>
          </tr>
          <tr>
              <td class="text-right text-info">政策类型</td>
              <td>{{getPolicyTypeDesc(detail.policyType)}}</td>
          </tr>
          <tr>
              <td class="text-right text-info">国内国际</td>
              <td>{{getIntlPolicyDesc(detail.intlPolicy)}}</td>
          </tr>
          <tr>
              <td class="text-right text-info">单程往返</td>
              <td>{{getRouteTypeDesc(detail.routeType)}}</td>
          </tr>
          <tr>
