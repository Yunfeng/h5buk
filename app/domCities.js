...
hotCities[3] = new Array('HGH','杭州','HANGZHOU','HZ');
hotCities[4] = new Array('CAN','广州','GUANGZHOU','GZ'); 
hotCities[5] = new Array('NKG','南京','NANJING','NJ');
...
citys[36] = new Array('SIA','西安','XIAN','XA');
...
citys[140] = new Array('SWA','揭阳','JIEYANG','JY');
...
citys[156] = new Array('BJS','北京','BEIJING','BJ');
