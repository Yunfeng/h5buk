...
import { searchChangeOrders } from '../api/order.js'
...
export default {
  ...
  methods: {
    ...
    showDetail: function (orderInfo) {
      ...
      this.$store.commit('setChangeOrderInfo', orderInfo)
      this.$router.push('/change/detail/' + orderInfo.id)
    },
